...
public class Test {
    ...
    public Book[] initBook(StockLevel[] stockLevels) {
        ...
        Book book1 = new Book( 1,"Война и мир", "Лев Толстой", 4, BookStatus.IN_STOCK, stockLevels[0], null, LocalDate.of(2013,04,06), LocalDate.of(2012,05,20));
        ...
        Book book3 = new Book(3,"Мертвые души", "Гоголь Николай", 4, BookStatus.OUT_OF_STOCK, stockLevels[2], null, LocalDate.of(2015,05,13), LocalDate.of(1998,01,05));
        ...
        Book book5 = new Book(5,"Руслан и Людмила", "Александр Пушкин", 5, BookStatus.IN_STOCK, stockLevels[4], null, LocalDate.of(2018,06,14), LocalDate.of(2011,06,01));
        ...
        Book book7 = new Book(7,"Психология влияния", "Роберт Чалдини", 6, BookStatus.IN_STOCK, stockLevels[6], null,LocalDate.of (2017,04,06), LocalDate.of(2001,02,18));
