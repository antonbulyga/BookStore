...
public class Test {
    ...
    public static Book[] initBook(BookService bookService, Store store) {
        ...
        Book book1 = new Book( 1,"Война и мир", "Лев Толстой", 4, BookStatus.IN_STOCK, null, LocalDate.of(2020,04,06), LocalDate.of(2012,05,20));
        arrayOfBookInStorehouse = bookService.addBook(store, book1);
        Book book2 = new Book(2,"Преступление и наказание", "Федор Достоевский", 3.5, BookStatus.OUT_OF_STOCK, null, LocalDate.of(2020,06,5), LocalDate.of(1996,05,25));
        arrayOfBookInStorehouse = bookService.addBook(store, book2);
        Book book3 = new Book(3,"Мертвые души", "Гоголь Николай", 4, BookStatus.IN_STOCK,  null, LocalDate.of(2015,05,13), LocalDate.of(1998,01,05));
        arrayOfBookInStorehouse = bookService.addBook(store, book3);
        Book book4 = new Book(4,"Война и мир", "Лев Толстой", 4, BookStatus.IN_STOCK,null, LocalDate.of(2020,03,04), LocalDate.of(2006,02,24));
        ...
        Book book6 = new Book(6,"Введение в психоанализ", "Зигмунд Фрейд", 7, BookStatus.IN_STOCK,null, LocalDate.of(2018,03,13), LocalDate.of(2020,01,4));
        ...
        Book book8 = new Book(8,"Как перестать беспокоитьс и начать жить", "Дейл Карнеги", 7, BookStatus.IN_STOCK, null, LocalDate.of(2020,02,27), LocalDate.of(2000,02,19));
